...
The Archer D1X seems as though it may be suseptible to replay attacks, however we haven't been able finish testing this. During setup, only the base reciever produces a bluetooth pairing packet, which seems to start with a MAC address of 00:A0, which is non-standard. The software additionally isn't updatable as far as we can tell.
